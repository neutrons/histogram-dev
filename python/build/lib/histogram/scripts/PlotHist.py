...
def plotH5File(h5filename, pathinh5file=None, min=None, max=None, output=None, **kwds):
...
def main():
    ...
    parser.add_option(
        "", "--min", dest="min", default=None, type="float", help="minimum"
    )
    parser.add_option(
        "", "--max", dest="max", default=None, type="float", help="maximum"
    )
    parser.add_option(
        "", "--output", dest="output", default="window", help="window or filename.png"
    )

    parser.add_option("", "--colormap", dest="cmap", default=None, help="color map")
