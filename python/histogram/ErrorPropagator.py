...
class ErrorPropagator:
    ...
    def __iadd__(self, this, other):
        ...
        if other._error2 is None and this._error2 is None:
            return this
        this._error2 = this._error2 or 0
        if other._error2 is not None:
            this._error2 += other._error2
        return this
    ...
    def __itruediv__(self, this, other):
        ...
        if dy2 is None and this._error2 is None:
            return this
        ...
        x, dx2 = this._value, this._error2
        if dx2 is None or dx2 == 0 or dx2 == 0.0:
