...
namespace ARCSStdVectorTest
{
    ...
    bool test_vec_divideEquals()
    {
        journal::info_t info("ARCSStdVectorTest");

        using namespace vec_divideEquals;

        info << journal::at(__HERE__) << journal::endl;

        bool passed1 = 
            testFrame( target, aspect1, info, vec_divideEquals::test_1);
        bool passed2 = 
            testFrame( target, aspect2, info, vec_divideEquals::test_2);
        bool passed3 = 
            testFrame( target, aspect3, info, vec_divideEquals::test_3);
...
// version
// $Id: stdVectorTest_vec_divideEquals.cc 73 2005-05-17 23:36:46Z tim $
