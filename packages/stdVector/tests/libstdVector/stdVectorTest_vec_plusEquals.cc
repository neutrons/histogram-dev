...
namespace ARCSStdVectorTest
{
    ...
    namespace vec_plusEquals
    {
        ...
        bool test_1()
        {
            ...
            ARCSStdVector::vec_plusEquals( rhs, 1,5, lhs, 0);
        ...
        bool test_3()
        {
            ...
            try
            {
                ARCSStdVector::vec_plusEquals( input, 6, 5, output, 0);
            ...
            try
            {
                ARCSStdVector::vec_plusEquals( input, 1, 6, output, 0);
            ...
            try
            {
                ARCSStdVector::vec_plusEquals( input, 0, 5, output, 0);
...
// version
// $Id: stdVectorTest_vec_plusEquals.cc 73 2005-05-17 23:36:46Z tim $
