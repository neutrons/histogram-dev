...
#include "stdVectorTest_vec_divide.h"
...
namespace StdVectorTest
{
    ...
    namespace vec_divide
    {
        char target[] = "ARCSStdVector::vec_divideEquals";
        char aspect1 [] = "with template type double";
        char aspect2 [] = "with template type unsigned int";
        char aspect3 [] = "exception paths";
    }

    bool test_vec_divide()
    {
        journal::info_t info( journalname);

        using namespace vec_divide;

        info << journal::at(__HERE__) << journal::endl;

        bool passed1 = 
            testFrame( target, aspect1, info, vec_divide::test_1);
        bool passed2 = 
            testFrame( target, aspect2, info, vec_divide::test_2);
        bool passed3 = 
            testFrame( target, aspect3, info, vec_divide::test_3);
    ...
    namespace vec_divide
    {
        ...
        bool test_1()
        {
            ...
            ARCSStdVector::vec_times( rhs, lhs, 1,5, lhs, 0);
        ...
        bool test_3()
        {
            ...
            try
            {
                ARCSStdVector::vec_times( input, input, 6, 5, output, 0);
            ...
            try
            {
                ARCSStdVector::vec_times( input, input, 1, 6, output, 0);
            ...
            try
            {
                ARCSStdVector::vec_times( input, input, 0, 5, output, 0);
...
// version
// $Id: stdVectorTest_vec_divide.cc 73 2005-05-17 23:36:46Z tim $
