...
class DatasetBase(object):
    ...
    def attribute(self, name):
        ...
        raise NotImplementedError(msg.format(self.__class__.__name__, "attribute"))
    ...
    def name(self):
        ...
        raise NotImplementedError(msg.format(self.__class__.__name__, "name"))
    ...
    def shape(self):
        ...
        raise NotImplementedError(msg.format(self.__class__.__name__, "shape"))

    def storage(self):
        """storage() -> storage object"""
        raise NotImplementedError(msg.format(self.__class__.__name__, "storage"))

    def typecode(self):
        """typecode() -> type code"""
        raise NotImplementedError(msg.format(self.__class__.__name__, "typecode"))

    def typecodeAsC(self):
        """typecodeAsC() -> code
        get type code as C type ('float', 'double', 'int', 'unsigned')"""
        raise NotImplementedError(msg.format(self.__class__.__name__, "typecodeAsC"))

    def typecodeAsNA(self):
        """typecodeAsNA() -> code
        typecode translated to numpy type ('Float32', 'Float64', 'Int32',
        'UInt32)"""
        raise NotImplementedError(msg.format(self.__class__.__name__, "typecodeAsNA"))
    ...
    def unit(self):
        ...
        raise NotImplementedError(msg.format(self.__class__.__name__, "unit"))

    def __init__(self, name="", unit="", attributeCont=None, shape=[], storage=None):
    ...
    _typesSV2C = {5: "float", 6: "double", 24: "int", 25: "unsigned"}

    _typesC2SV = {"float": 5, "double": 6, "int": 24, "unsigned": 25}

    _typesSV2NA = {5: "Float32", 6: "Float64", 24: "Int32", 25: "UInt32"}

    _typesNA2SV = {"Float32": 5, "Float64": 6, "Int32": 24, "UInt32": 25}
