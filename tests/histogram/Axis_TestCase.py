...
class Axis_TestCase(TestCase):
    def testContinuousMapper(self):
        ...
        self.assertEqual(axis.cellIndexFromValue(0.0), 0)
        self.assertEqual(axis.cellIndexFromValue(1.0), 1)
        self.assertEqual(axis.cellIndexFromValue(2.0), 2)
    ...
    def testSlicing(self):
        ...
        self.assertVectorAlmostEqual(
            new.storage().asList(), [1.05, 1.15, 1.25, 1.35, 1.45, 1.55]
        )

        new = axis[SlicingInfo((1.0, 1.9))]
        self.assertVectorAlmostEqual(new.storage().asList(), axis.storage().asList())
    ...
    def test_rsub(self):
        ...
        self.assertAlmostEqual(centers[1], -9)
    ...
    def test_changeUnit(self):
        ...
        self.assertVectorAlmostEqual(
            taxis.binBoundaries().asNumarray(), [-500, 500, 1500, 2500]
        )
